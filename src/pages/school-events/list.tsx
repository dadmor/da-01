// src/pages/school-events/list.tsx
...
import { Eye, Edit, Calendar, MapPin, Users, Plus, Music, GraduationCap } from "lucide-react";
...
export const SchoolEventsList = () => {
  ...
  return (
    <>
      <FlexBox>
        <Lead
          title="Wydarzenia szkół tańca"
          description="Warsztaty, imprezy i kursy organizowane przez szkoły"
        />
        <Button onClick={() => create("school_events")}>
      ...
      <FlexBox className="gap-4">
        ...
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="party">Impreza</SelectItem>
                  ...
                  <div className="flex-1">
                    <FlexBox className="mb-2">
                      ...
                      <Badge variant={event.type === "workshop" ? "default" : "outline"}>
                        {event.type === "workshop" ? "Warsztaty" : 
                         event.type === "party" ? "Impreza" :
                         event.type === "course" ? "Kurs" : "Bootcamp"}
                      </Badge>
                    </FlexBox>
              ...
              <CardFooter>
                <FlexBox className="w-full">
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => show("school_events", event.id)}
                    className="flex-1"
                  >
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => edit("school_events", event.id)}
                    disabled={isPast}
                  >
